...
export default function AddUser() {
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div className="space-y-2">
            ...
            {errors.username ? (
              ...
              <p className="text-gray-400 text-xs">Username must contain letters only.</p>
            )}
          </div>
  ...
  {errors.first_name ? (
    ...
    <p className="text-gray-400 text-xs">First Name must contain letters only.</p>
  )}
</div>
...
<div className="space-y-2">
  ...
  {errors.last_name ? (
    ...
    <p className="text-gray-400 text-xs">Last Name must contain letters only.</p>
  )}
</div>
...
<div className="space-y-2">
  ...
  {errors.address ? (
    ...
    <p className="text-gray-400 text-xs">
      Address must contain only letters, numbers, spaces, commas, periods, or dashes.
    </p>
  )}
</div>
...
<div className="space-y-2">
  ...
  {errors.password ? (
    ...
    <p className="text-gray-400 text-xs">Password must be at least 4 characters.</p>
  )}
</div>
